    ...
    execute(message, args) {
        const output = functions.newEmbed()
            ...
            .addField('Do not ask unnecessary questions',
                `Before asking for support or reporting a bug, please see if your problem has a solution on our bot (${functions.prefix}help) and use the discord search tool.\nThis way, 95% of the problems can be solved without us having to waste time on explaining the same thing over and over.`,
                false)
