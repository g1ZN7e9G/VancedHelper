...
module.exports = {
	...
	execute(message, args) {
        ...
        .setDescription('You are not using the recommended (black) version. This is no big deal, but if you don\'t use Black, you have to install MicroG first or your Vanced will constantnly crash. This issue is easily fixed.')
        .setTimestamp()
